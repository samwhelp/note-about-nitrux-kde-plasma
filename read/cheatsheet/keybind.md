...
| 設定檔 |
| ----- |
| [~/.config/kglobalshortcutsrc](https://github.com/samwhelp/nitrux-kde-plasma-adjustment/blob/main/prototype/main/nitrux-config/locale/en_us/Nitrux-Dark/asset/overlay/etc/skel/.config/kglobalshortcutsrc) |
...
因為在「[~/.config/plasma-org.kde.plasma.desktop-appletsrc](https://github.com/samwhelp/nitrux-kde-plasma-adjustment/blob/main/prototype/main/full-config/locale/en_us/Nitrux-Dark/asset/overlay/etc/skel/.config/plasma-org.kde.plasma.desktop-appletsrc#L221-L249)」，有一個「元件 (P-Connor.PlasmaDrawer)」。
...
所以在「[~/.config/kglobalshortcutsrc](https://github.com/samwhelp/nitrux-kde-plasma-adjustment/blob/main/prototype/main/nitrux-config/locale/en_us/Nitrux-Dark/asset/overlay/etc/skel/.config/kglobalshortcutsrc)」會被自動設定「`activate widget 116=Alt+F1,none,Activate Plasma Drawer Widget
`」。
...
| 相關連結 |
| ------- |
| [鍵盤按鍵綁定](https://samwhelp.github.io/note-about-nitrux-kde-plasma/read/config/keybind.html) |
